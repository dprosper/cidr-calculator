...
const inputStyles = tv({
  base: [
    // base
    "relative block w-full appearance-none px-2.5 py-2 shadow-sm outline-none transition sm:text-sm",
    // border color
    "border-ibm-gray border-t-0 border-l-0 border-r-0 dark:border-gray-800",
    // text color
